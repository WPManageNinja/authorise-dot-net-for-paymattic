...
require_once AUTHORIZE_DOT_NET_FOR_PAYMATTIC_DIR . '/Settings/AuthorizeElement.php';
require_once AUTHORIZE_DOT_NET_FOR_PAYMATTIC_DIR . '/Settings/AuthorizeSettings.php';
require_once AUTHORIZE_DOT_NET_FOR_PAYMATTIC_DIR . '/API/IPN.php';
...
class AuthorizeProcessor
{
    ...
    {
        new  \AuthorizeDotNetForPaymattic\Settings\AuthorizeElement();
        (new  \AuthorizeDotNetForPaymattic\Settings\AuthorizeSettings())->init();
    ...
    public function choosePaymentMethod($paymentMethod, $elements, $formId, $form_data)
    {
        ...
        foreach ($elements as $element) {
            if ((isset($element['type']) && $element['type'] == 'authorize_gateway_element')) {
                return 'authorize';
            }
        }
        return $paymentMethod;
